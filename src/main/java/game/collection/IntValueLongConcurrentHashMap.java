...
public class IntValueLongConcurrentHashMap {
    ...
    public final class IntValueIterator extends HashIterator implements ReusableIterator<Integer>, Enumeration<Integer> {
        public Integer next() {
    ...
    final class EntryIterator extends HashIterator implements ReusableIterator<IntValueLongHashMap.Entry> {
