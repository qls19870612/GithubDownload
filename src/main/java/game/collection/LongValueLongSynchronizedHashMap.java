...
public class LongValueLongSynchronizedHashMap {
    ...
    public long increment(long key, long amount) {
        if (amount <= 0) {
            throw new IllegalArgumentException("LongValueLongConcurrentHashMap.increment��amount�������0: " + amount);
        }
    ...
    public final class LongKeyIterator extends HashIterator implements ReusableIterator<Long>, Enumeration<Long> {
        @Override
        public Long next() {
    ...
    public final class LongValueIterator extends HashIterator implements ReusableIterator<Long>, Enumeration<Long> {
        @Override
        public Long next() {
    ...
    public final class EntryIterator extends HashIterator implements ReusableIterator<Entry>, Enumeration<Entry> {
        @Override
        public Entry next() {
    ...
    final class KeySet extends AbstractSet<Long> {
        ...
        public boolean contains(Object o) {
            if (o instanceof Long) {
                return LongValueLongSynchronizedHashMap.this.containsKey((Long) o);
            }
            return false;
        }
