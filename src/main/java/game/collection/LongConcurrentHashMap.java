 ...
 */
public class LongConcurrentHashMap<V> extends ReentrantLock {
    /*
    ...
    public LongConcurrentHashMap(int initialCapacity, float lf) {
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            LongConcurrentHashMap.this.remove(lastReturned.hash);
            lastReturned = null;
        }
    ...
    final class KeySet extends AbstractSet<Long> {
        ...
        public boolean contains(Object o) {
            if (o instanceof Long) {
                return LongConcurrentHashMap.this.containsKey((Long) o);
            }
            return false;
        }
        ...
        public boolean remove(Object o) {
            if (o instanceof Long) {
                return LongConcurrentHashMap.this.remove((Long) o) != null;
            }
            return false;
        }
    ...
    final class EntrySet extends AbstractSet<LongHashMap.Entry<V>> {
        ...
        public boolean remove(Object o) {
            ...
            LongHashMap.Entry<?> e = (LongHashMap.Entry<?>) o;
            return LongConcurrentHashMap.this.remove(e.getKey(), e.getValue()) != null;
        }
