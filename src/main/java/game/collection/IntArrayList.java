...
public class IntArrayList implements RandomAccess, Cloneable {
    ...
    public IntArrayList reverseList() {
        return (reverseL != null) ? reverseL : (reverseL = new ReverseIntArrayList(this));
    }
    ...
    private class IntArraySubList extends IntArrayList {
        ...
        public IntArraySubList(IntArrayList parent, int offset, int fromIndex, int toIndex) {
            super(true);
            this.parent = parent;
