 ...
 *
 */
public class LongValueIntHashMap {
     ...
     *   than zero.
     */
    public LongValueIntHashMap(int initialCapacity) {
     ...
     */
    public LongValueIntHashMap(int initialCapacity, float loadFactor) {
        super();
    ...
    private abstract class HashIterator<E> implements Iterator<E> {
        ...
        public void remove() {
            ...
            int k = current.hash;
            current = null;
            LongValueIntHashMap.this.removeEntryForKey(k);
        }
    ...
    private final class EntrySet extends AbstractSet<Entry> {
        ...
        @Override
        public void clear() {
            LongValueIntHashMap.this.clear();
        }
    }
