...
import game.collection.IntConcurrentKeygenMap.IntKeySetter;
...
public class IntConcurrentKeygenMap<V extends IntKeySetter> {
    ...
    public IntConcurrentKeygenMap(int startKey, int maxKey, int initialCapacity, float lf) {
        if (startKey < 0) {
    ...
    static final <V extends IntKeySetter> IntConcurrentKeygenMap<V>[] newArray(int i) {
