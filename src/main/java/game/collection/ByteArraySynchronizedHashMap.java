 ...
 * @param <V>
 */
public class ByteArraySynchronizedHashMap<V> {
    ...
    public ByteArraySynchronizedHashMap(int initialCapacity, float lf) {
    ...
    public ByteArraySynchronizedHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public ByteArraySynchronizedHashMap() {
        this(16, 0.75f);
    }

    @SuppressWarnings("unchecked")
    static final <V> ByteArraySynchronizedHashMap<V>[] newArray(int i) {
        return new ByteArraySynchronizedHashMap[i];
    }
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            ByteArraySynchronizedHashMap.this.remove(lastReturned.key);
            lastReturned = null;
        }
    ...
    final class KeyIterator extends HashIterator implements ReusableIterator<byte[]>, Enumeration<byte[]> {
        @Override
        public byte[] next() {
    ...
    final class EntryIterator extends HashIterator implements ReusableIterator<ByteArrayHashMap.Entry<V>> {
        @Override
    ...
    final class KeySet extends AbstractSet<byte[]> {
        ...
        @Override
        public int size() {
            return ByteArraySynchronizedHashMap.this.size();
        }

        @Override
        public boolean contains(Object o) {
            if (o instanceof byte[]) {
                return ByteArraySynchronizedHashMap.this.containsKey((byte[]) o);
            }
            return false;
        }
        ...
        public boolean remove(Object o) {
            if (o instanceof byte[]) {
                return ByteArraySynchronizedHashMap.this.remove((byte[]) o) != null;
            }
            return false;
        }
        ...
        @Override
        public void clear() {
            ByteArraySynchronizedHashMap.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ByteArraySynchronizedHashMap.this.containsValue(o);
        }
    ...
    final class EntrySet extends AbstractSet<ByteArrayHashMap.Entry<V>> {
        ...
        public boolean contains(Object o) {
            ...
            V v = ByteArraySynchronizedHashMap.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            ...
            ByteArrayHashMap.Entry<?> e = (ByteArrayHashMap.Entry<?>) o;
            return ByteArraySynchronizedHashMap.this.remove(e.getKey(), e.getValue()) != null;
        }
