 ...
 */
public class IntSynchronizedHashMap<V> {
    /*
    ...
    public IntSynchronizedHashMap(int initialCapacity, float lf) {
    ...
    public IntSynchronizedHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public IntSynchronizedHashMap() {
        this(16, 0.75f);
    }

    @SuppressWarnings("unchecked")
    static final <V> IntSynchronizedHashMap<V>[] newArray(int i) {
        return new IntSynchronizedHashMap[i];
    }
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            IntSynchronizedHashMap.this.remove(lastReturned.hash);
            lastReturned = null;
        }
    ...
    final class KeyIterator extends HashIterator implements ReusableIterator<Integer>, Enumeration<Integer> {
        @Override
        public Integer next() {
    ...
    final class EntryIterator extends HashIterator implements ReusableIterator<IntHashMap.Entry<V>> {
        @Override
    ...
    final class KeySet extends AbstractSet<Integer> {
        ...
        @Override
        public int size() {
            return IntSynchronizedHashMap.this.size();
        }

        @Override
        public boolean contains(Object o) {
            if (o instanceof Integer) {
                return IntSynchronizedHashMap.this.containsKey((Integer) o);
            }
            return false;
        }
        ...
        public boolean remove(Object o) {
            if (o instanceof Integer) {
                return IntSynchronizedHashMap.this.remove((Integer) o) != null;
            }
            return false;
        }
        ...
        @Override
        public void clear() {
            IntSynchronizedHashMap.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return IntSynchronizedHashMap.this.containsValue(o);
        }
    ...
    final class EntrySet extends AbstractSet<IntHashMap.Entry<V>> {
        ...
        public boolean contains(Object o) {
            ...
            V v = IntSynchronizedHashMap.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            ...
            IntHashMap.Entry<?> e = (IntHashMap.Entry<?>) o;
            return IntSynchronizedHashMap.this.remove(e.getKey(), e.getValue()) != null;
        }
