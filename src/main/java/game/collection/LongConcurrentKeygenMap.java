...
import game.collection.LongConcurrentKeygenMap.LongKeySetter;
 ...
 */
public class LongConcurrentKeygenMap<V extends LongKeySetter> {
    /*
    ...
    public LongConcurrentKeygenMap(long startKey, long maxKey, int initialCapacity, float lf) {
        if (startKey < 0) {
        ...
        if (startKey >= maxKey) {
            throw new IllegalArgumentException("start key must be less than max key.");
        }
    ...
    public LongConcurrentKeygenMap(long startKey, long maxKey, int initialCapacity) {
        this(startKey, maxKey, initialCapacity, 0.75f);
    }

    public LongConcurrentKeygenMap(long startKey, long maxKey) {
        this(startKey, maxKey, 16, 0.75f);
    }

    public LongConcurrentKeygenMap(long startKey) {
        this(startKey, Long.MAX_VALUE, 16, 0.75f);
    }

    public LongConcurrentKeygenMap() {
        this(0, Long.MAX_VALUE, 16, 0.75f);
    }

    @SuppressWarnings("unchecked")
    static final <V extends LongKeySetter> LongConcurrentKeygenMap<V>[] newArray(int i) {
        return new LongConcurrentKeygenMap[i];
    }
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            LongConcurrentKeygenMap.this.remove(lastReturned.hash);
            lastReturned = null;
        }
    ...
    final class KeySet extends AbstractSet<Long> {
        ...
        @Override
        public int size() {
            return LongConcurrentKeygenMap.this.size();
        }

        @Override
        public boolean contains(Object o) {
            if (o instanceof Long) {
                return LongConcurrentKeygenMap.this.containsKey((Long) o);
            }
            return false;
        }
        ...
        public boolean remove(Object o) {
            if (o instanceof Long) {
                return LongConcurrentKeygenMap.this.remove((Long) o) != null;
            }
            return false;
        }
        ...
        @Override
        public void clear() {
            LongConcurrentKeygenMap.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return LongConcurrentKeygenMap.this.containsValue(o);
        }
    ...
    final class EntrySet extends AbstractSet<LongHashMap.Entry<V>> {
        ...
        public boolean contains(Object o) {
            ...
            V v = LongConcurrentKeygenMap.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            ...
            LongHashMap.Entry<?> e = (LongHashMap.Entry<?>) o;
            return LongConcurrentKeygenMap.this.remove(e.getKey(), e.getValue()) != null;
        }
    ...
    public static interface LongKeySetter {
