 ...
 * @param <V>
 */
public class SingleWriteLongConcurrentHashMap<V> {
    /*
    ...
    public SingleWriteLongConcurrentHashMap(int initialCapacity, float lf) {
    ...
    public SingleWriteLongConcurrentHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public SingleWriteLongConcurrentHashMap() {
        this(16, 0.75f);
    }

    @SuppressWarnings("unchecked")
    static final <V> SingleWriteLongConcurrentHashMap<V>[] newArray(int i) {
        return new SingleWriteLongConcurrentHashMap[i];
    }
    ...
    public void clear() {
        if (count != 0) {
            table = HashEntry.newArray(table.length);
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            SingleWriteLongConcurrentHashMap.this.remove(lastReturned.hash);
            lastReturned = null;
        }
    ...
    final class KeySet extends AbstractSet<Long> {
        ...
        @Override
        public int size() {
            return SingleWriteLongConcurrentHashMap.this.size();
        }

        @Override
        public boolean contains(Object o) {
            if (o instanceof Long) {
                return SingleWriteLongConcurrentHashMap.this.containsKey((Long) o);
            }
            return false;
        }
        ...
        public boolean remove(Object o) {
            if (o instanceof Long) {
                return SingleWriteLongConcurrentHashMap.this.remove((Long) o) != null;
            }
            return false;
        }
        ...
        @Override
        public void clear() {
            SingleWriteLongConcurrentHashMap.this.clear();
        }
    }
    ...
    final class EntrySet extends AbstractSet<LongHashMap.Entry<V>> {
        ...
        public boolean remove(Object o) {
            ...
            return SingleWriteLongConcurrentHashMap.this.remove(e.getKey(), e.getValue()) != null;
        }
